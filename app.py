...
emotion_responses = {
    ...
    'anger': "I notice you're feeling angry. Remember to take deep breaths and process these feelings in a healthy way.",
    'approval': "I see you're expressing approval. It's great to recognize and appreciate things that align with your values.",
    'confusion': "It seems you're feeling confused. Taking time to sort through your thoughts can help bring clarity.",
    'disgust': "I detect feelings of disgust. Remember that strong negative reactions often tell us something important about our boundaries.",
    'fear': "I notice signs of fear in your writing. Remember that fear is a natural response, but try not to let it overwhelm you.",
    'happiness': "Your happiness shines through your words! What a wonderful feeling to celebrate.",
    'neutral': "Your tone seems quite neutral. Sometimes a balanced perspective helps us see things clearly.",
    'pride': "I sense pride in your words. It's important to recognize and celebrate your achievements.",
    'sadness': "I'm noticing signs of sadness. Remember that it's okay to feel down sometimes, and these feelings will pass.",
    'surprise': "Surprise comes through in your message. Unexpected events can certainly stir up strong emotions."
}
